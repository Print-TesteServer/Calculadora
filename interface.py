...
# Configurando janela
frame_cima = Frame(janela, width=340, height=100, bg=co1, relief='flat')
frame_cima.grid(row=0, column=0)

frame_baixo = Frame(janela,width=340, height=360, bg=co2, relief='flat')
...
b_2 = Button(frame_baixo, text="%", width=8, height=2,font=('Arial 12 bold'),bg=co3,relief='raised', overrelief='ridge')
b_2.place(x=160, y=0)

b_3 = Button(frame_baixo, text="/", width=8, height=2,font=('Arial 12 bold'),bg=co3,relief='raised', overrelief='ridge')
b_3.place(x=250, y=0)

b_4 = Button(frame_baixo, text="*", width=8, height=2,font=('Arial 12 bold'),bg=co3,relief='raised', overrelief='ridge')
b_4.place(x=250, y=52)

b_5 = Button(frame_baixo, text="-", width=8, height=2,font=('Arial 12 bold'),bg=co3,relief='raised', overrelief='ridge')
b_5.place(x=250, y=104)

b_6 = Button(frame_baixo, text="+", width=8, height=2,font=('Arial 12 bold'),bg=co3,relief='raised', overrelief='ridge')
b_6.place(x=250, y=156)

b_7 = Button(frame_baixo, text="=", width=8, height=2,font=('Arial 12 bold'),bg=co3,relief='raised', overrelief='ridge')
